...
cv2.resizeWindow('Pen Tracker', 400, 0)
cv2.createTrackbar("High Hue", "Pen Tracker", savedValues[1][0], 179, fun_emp)
cv2.createTrackbar("High Saturation", "Pen Tracker", savedValues[1][1], 255, fun_emp)
cv2.createTrackbar("High Value", "Pen Tracker", savedValues[1][2], 255, fun_emp)
cv2.createTrackbar("Low Hue", "Pen Tracker", savedValues[0][0], 180, fun_emp)
cv2.createTrackbar("Low Saturation", "Pen Tracker", savedValues[0][1], 255, fun_emp)
cv2.createTrackbar("Low Value", "Pen Tracker", savedValues[0][2], 255, fun_emp)
...
show_Cam = show_Whiteboard = show_Mask = True
